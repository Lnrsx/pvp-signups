...
class Booking(object):
    ...
    price_recommendation: Optional[:class:`int`]
    ...
    booster: Optional[:class:`int`]
        The user ID of the primary booster. Could be None.
    booster_2: Optional[:class:`int`]
    ...
    boost_cut_2: :class:`int`
        The gold cut of the secondary booster. Will be 0 if price is 0.
    ad_cut: :class:`int`
        The gold cut of the advertisder (booking author). Will be 0 if price is 0.
    management_cut: :class:`int`
    ...
    def get(cls, bookingid):
        """Optional[:class:`Booking`]: Returns the booking instance from ID if it exists, ``None`` otherwise.
    ...
    def author(self) -> discord.User:
        """:class:`discord.User`: Gets the owner of the booking instance.
    ...
    def authorid(self) -> int:
        """:class:`int`: Gets the user ID of the booking."""
    ...
    def cache(self):
        ...
        .. note::
            All attributes of the booking that are classes are converted to :class:`int` in ID form
         """
        with open("data/bookings.json", "r") as f:
            data = json.load(f)
